export default function NavButtons({ showPlayersBox, setShowPlayersBox, logIn, setLogIn, showNotificationBox, setShowNotificationBox, showUserInterestsBox, setShowUserInterestsBox, showPlay2Win, setShowPlay2Win, showStoreBox, setShowStoreBox }) {
  return (
    <div className="flex flex-row-reverse justify-around w-full">
      ...
      >
        <svg
          ...
          <g id="SVGRepo_iconCarrier">
            <path d="M11 8L12.5 6.5V10.5" stroke="white" stroke-width="1.5" stroke-linecap="round"
            ...
            <path
              ...
              stroke="white" stroke-width="1.5"></path>
            <path d="M12 16V19" stroke="white" stroke-width="1.5" stroke-linecap="round"></path>
            <path
            ...
            <path d="M18 22H6" stroke="white" stroke-width="1.5" stroke-linecap="round"></path>
            <path
      ...
      >
        <svg
          className="w-8"
          viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M21 12C21 16.714 21 19.0711 19.682 20.5355C18.364 22 16.2426 22 12 22C7.75736 22 5.63604 22 4.31802 20.5355C3 19.0711 3 16.714 3 12C3 7.28595 3 4.92893 4.31802 3.46447C5.63604 2 7.75736 2 12 2C16.2426 2 18.364 2 19.682 3.46447C20.5583 4.43821 20.852 5.80655 20.9504 8" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path> <path d="M8.11177 9.94889C7.59413 9.81019 7.18981 9.40587 7.05111 8.88823C7 8.69748 7 8.46499 7 8C7 7.53501 7 7.30252 7.05111 7.11177C7.18981 6.59413 7.59413 6.18981 8.11177 6.05111C8.30252 6 8.53501 6 9 6H15C15.465 6 15.6975 6 15.8882 6.05111C16.4059 6.18981 16.8102 6.59413 16.9489 7.11177C17 7.30252 17 7.53501 17 8C17 8.46499 17 8.69748 16.9489 8.88823C16.8102 9.40587 16.4059 9.81019 15.8882 9.94889C15.6975 10 15.465 10 15 10H12" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path> <path d="M8.5 14V17M7 15.5L10 15.5" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M16.3333 13.8333C16.3333 14.2936 15.9602 14.6667 15.5 14.6667C15.0398 14.6667 14.6667 14.2936 14.6667 13.8333C14.6667 13.3731 15.0398 13 15.5 13C15.9602 13 16.3333 13.3731 16.3333 13.8333Z" fill="#ffffff"></path> <path d="M16.3333 17.1667C16.3333 17.6269 15.9602 18 15.5 18C15.0398 18 14.6667 17.6269 14.6667 17.1667C14.6667 16.7064 15.0398 16.3333 15.5 16.3333C15.9602 16.3333 16.3333 16.7064 16.3333 17.1667Z" fill="#ffffff"></path> <path d="M14.6667 15.5C14.6667 15.9602 14.2936 16.3333 13.8333 16.3333C13.3731 16.3333 13 15.9602 13 15.5C13 15.0398 13.3731 14.6667 13.8333 14.6667C14.2936 14.6667 14.6667 15.0398 14.6667 15.5Z" fill="#ffffff"></path> <path d="M18 15.5C18 15.9602 17.6269 16.3333 17.1667 16.3333C16.7064 16.3333 16.3333 15.9602 16.3333 15.5C16.3333 15.0398 16.7064 14.6667 17.1667 14.6667C17.6269 14.6667 18 15.0398 18 15.5Z" fill="#ffffff"></path> </g></svg>
      </button>
      ...
      >
        <svg className="w-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M9.5 21.5V18.5C9.5 17.5654 9.5 17.0981 9.70096 16.75C9.83261 16.522 10.022 16.3326 10.25 16.201C10.5981 16 11.0654 16 12 16C12.9346 16 13.4019 16 13.75 16.201C13.978 16.3326 14.1674 16.522 14.299 16.75C14.5 17.0981 14.5 17.5654 14.5 18.5V21.5" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path> <path d="M21 22H9M3 22H5.5" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path> <path d="M19 22V15" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path> <path d="M5 22V15" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path> <path d="M11.9999 2H7.47214C6.26932 2 5.66791 2 5.18461 2.2987C4.7013 2.5974 4.43234 3.13531 3.89443 4.21114L2.49081 7.75929C2.16652 8.57905 1.88279 9.54525 2.42867 10.2375C2.79489 10.7019 3.36257 11 3.99991 11C5.10448 11 5.99991 10.1046 5.99991 9C5.99991 10.1046 6.89534 11 7.99991 11C9.10448 11 9.99991 10.1046 9.99991 9C9.99991 10.1046 10.8953 11 11.9999 11C13.1045 11 13.9999 10.1046 13.9999 9C13.9999 10.1046 14.8953 11 15.9999 11C17.1045 11 17.9999 10.1046 17.9999 9C17.9999 10.1046 18.8953 11 19.9999 11C20.6373 11 21.205 10.7019 21.5712 10.2375C22.1171 9.54525 21.8334 8.57905 21.5091 7.75929L20.1055 4.21114C19.5676 3.13531 19.2986 2.5974 18.8153 2.2987C18.332 2 17.7306 2 16.5278 2H16" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
      </button>
        ...
        <svg
          ...
          <g id="SVGRepo_iconCarrier">
            <path
              ...
              stroke={showUserInterestsBox || showPlay2Win || showNotificationBox || showPlayersBox || logIn || showStoreBox ? "white" : "none"} stroke-width="1.5" stroke-linecap="round"></path>
            <path d="M15 18H9" stroke={showUserInterestsBox || showPlay2Win || showNotificationBox || showPlayersBox || logIn || showStoreBox ? "white" : "none"} stroke-width="1.5" stroke-linecap="round"></path>
          </g>
        </svg>
      </button>
    </div>
