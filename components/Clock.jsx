...
export default function Clock({ time, setTime, volume, setVolume, darkMode, setDarkMode }) {
  useEffect(() => {
  ...
  return (
    <section className="flex items-center justify-center gap-36 w-[1100px] p-1 font-thin text-2xl drop-shadow-[0_0_1px_rgba(255,255,255,0.7)] h-[50px] backdrop-blur-[5px] rounded-b-3xl border border-t-transparent">
      <div>{time}</div>
