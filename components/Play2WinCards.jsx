  ...
  return (
    <>
      <div className="flex justify-center items-center gap-4 w-full h-[238px] overflow-x-auto scroll-smooth ps-scroll pb-2">
        <span className={`flex flex-col justify-center items-center gap-3 rounded-full cursor-pointer w-[28%] h-[90%] transition-all border-transparent border bg-[#e6e9ee] dark:bg-[#1a1a1a] hover:border-blue-600 dark:hover:border-blue-500 backdrop-blur-[5px] flex-shrink-0`}></span> {/* ${isChoosen ? ("") : ("")} */}
        <span className={`flex flex-col justify-center items-center gap-3 rounded-full cursor-pointer w-[28%] h-[90%] transition-all border-transparent border bg-[#e6e9ee] dark:bg-[#1a1a1a] hover:border-blue-600 dark:hover:border-blue-500 backdrop-blur-[5px] flex-shrink-0`}></span> {/* ${isChoosen ? ("") : ("")} */}
        <span className={`flex flex-col justify-center items-center gap-3 rounded-full cursor-pointer w-[28%] h-[90%] transition-all border-transparent border bg-[#e6e9ee] dark:bg-[#1a1a1a] hover:border-blue-600 dark:hover:border-blue-500 backdrop-blur-[5px] flex-shrink-0`}></span> {/* ${isChoosen ? ("") : ("")} */}
      </div>
